...
#define PKCS11_RV_UNDEFINED_ID			PKCS11_UNDEFINED_ID
 ...
 */
#define PKCS11_BOOLPROPS_BASE			0x00000000
...
#define PKCS11_BOOLPROPS_END			0x0000003F
#define PKCS11_BOOLPROPH_FLAG			BIT(31)
...
#define PKCS11_CKM_ECDSA_SHA224			0x018
#define PKCS11_CKM_ECDSA_SHA256			0x019
#define PKCS11_CKM_ECDSA_SHA384			0x01a
#define PKCS11_CKM_ECDSA_SHA512			0x01b
...
/* PKCS11 added IDs for operation without cryptoki mechanism ID defined */
 ...
 * C structures.
 *
 * Processing parameters are used as argument in C_EncryptInit() and friends
